...
public class AddressActivity extends Activity {
   ...
   StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*IntentIntegrator intentIntegrator = new IntentIntegrator(AddressActivity.this);
    ...
    public void saveAddress(){
    	...
    	if(prefs.getString("StoredList", null)== null){
    		addresses = new Address[1];
        	System.out.println("address array made - empty");
    	}
    	else{
    		savedAddresses = getAddressList();
    		addresses = new Address[savedAddresses.length+1];
    		for(int i=0;i<savedAddresses.length;i++){
    			addresses[i]= savedAddresses[i];
    		}
    		System.out.println("address array made - hadData");
    	}
    ...
    public void launchLoadAddress(){
    	new LoadAddress().execute("");
		new DownloadImageTask((ImageView) findViewById(R.id.imageView1))
        .execute("http://zxing.org/w/chart?cht=qr&chs=450x450&chld=L&choe=UTF-8&chl="+stringAddress);	
    }
    public void setStringAddress(){
    	stringAddress = "PDn23vkgxmWvYHXgiuzQrCDxzV3j67g3YM";
    }
    ...
    public String getAccountBalance(){
    	InputStream source = retrieveStream("http://potchain.aprikos.net/chain/Potcoin/q/addressbalance/"+stringAddress);
...
private InputStream retrieveStream(String url) {
    ...
    private class LoadAddress extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
		    ...
		    scanner_value.setText(stringAddress);
           ...
           // startActivity(new Intent(AddressActivity.this, AddressListActivity.class));
        }
        @Override
